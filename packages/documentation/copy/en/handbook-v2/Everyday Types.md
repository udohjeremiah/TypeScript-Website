...
Being concerned only with the structure and capabilities of types is why we call TypeScript a _structurally typed_ type system, the opposite being a _nominally typed_ type system; the opposite is a _nominally typed_ type system, where type compatibility is based on the names of the types rather than their structure.
